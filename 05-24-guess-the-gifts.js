...
const guessGifts = (wishlist, presents) => wishlist.filter(present => presents.some(c => c['size'] === present['size'] && c['clatters'] === present['clatters'] && c['weight'] === present['weight'])).map(v => v['name']);
